 ...
 * @generated */
public class FVWindow extends Window {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(FVWindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected FVWindow() {/* intentionally empty block */}
   ...
   */
  public FVWindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public FVWindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
