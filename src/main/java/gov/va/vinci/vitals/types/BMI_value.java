 ...
 * @generated */
public class BMI_value extends Output_Value {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BMI_value.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BMI_value() {/* intentionally empty block */}
   ...
   */
  public BMI_value(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public BMI_value(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
