 ...
 * @generated */
public class HiPrecisionWindow extends Window {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(HiPrecisionWindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected HiPrecisionWindow() {/* intentionally empty block */}
   ...
   */
  public HiPrecisionWindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public HiPrecisionWindow(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public HiPrecisionWindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
