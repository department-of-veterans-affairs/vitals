...
public class Pain_Term extends Term {
  ...
  public final static int typeIndexID = JCasRegistry.register(Pain_Term.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Pain_Term() {/* intentionally empty block */}
   ...
   */
  public Pain_Term(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Pain_Term(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
