...
public class Height_Term extends Term {
  ...
  public final static int typeIndexID = JCasRegistry.register(Height_Term.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Height_Term() {/* intentionally empty block */}
   ...
   */
  public Height_Term(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Height_Term(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
