 ...
 * @generated */
public class Month extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Month.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Month() {/* intentionally empty block */}
   ...
   */
  public Month(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Month(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
