...
public class Weight_Term extends Term {
  ...
  public final static int typeIndexID = JCasRegistry.register(Weight_Term.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Weight_Term() {/* intentionally empty block */}
   ...
   */
  public Weight_Term(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Weight_Term(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
