 ...
 * @generated */
public class ExcludePrefix extends RegularExpressionType {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ExcludePrefix.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ExcludePrefix() {/* intentionally empty block */}
   ...
   */
  public ExcludePrefix(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ExcludePrefix(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ExcludePrefix(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
