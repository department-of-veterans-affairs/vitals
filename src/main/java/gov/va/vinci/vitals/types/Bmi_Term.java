 ...
 * @generated */
public class Bmi_Term extends Term {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Bmi_Term.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Bmi_Term() {/* intentionally empty block */}
   ...
   */
  public Bmi_Term(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Bmi_Term(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
