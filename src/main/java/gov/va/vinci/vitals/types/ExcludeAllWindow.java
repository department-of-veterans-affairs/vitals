 ...
 * @generated */
public class ExcludeAllWindow extends Window {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ExcludeAllWindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ExcludeAllWindow() {/* intentionally empty block */}
   ...
   */
  public ExcludeAllWindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ExcludeAllWindow(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ExcludeAllWindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
