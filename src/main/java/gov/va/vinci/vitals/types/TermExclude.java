...
public class TermExclude extends Pattern {
  ...
  public final static int typeIndexID = JCasRegistry.register(TermExclude.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected TermExclude() {/* intentionally empty block */}
   ...
   */
  public TermExclude(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public TermExclude(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
