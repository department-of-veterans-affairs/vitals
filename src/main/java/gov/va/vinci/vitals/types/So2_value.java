 ...
 * @generated */
public class So2_value extends Output_Value {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(So2_value.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected So2_value() {/* intentionally empty block */}
   ...
   */
  public So2_value(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public So2_value(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
