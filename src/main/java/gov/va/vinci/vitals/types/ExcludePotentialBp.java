...
public class ExcludePotentialBp extends Pattern {
  ...
  public final static int typeIndexID = JCasRegistry.register(ExcludePotentialBp.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ExcludePotentialBp() {/* intentionally empty block */}
   ...
   */
  public ExcludePotentialBp(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public ExcludePotentialBp(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public ExcludePotentialBp(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
