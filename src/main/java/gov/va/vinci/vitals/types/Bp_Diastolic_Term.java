...
public class Bp_Diastolic_Term extends Term {
  ...
  public final static int typeIndexID = JCasRegistry.register(Bp_Diastolic_Term.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Bp_Diastolic_Term() {/* intentionally empty block */}
   ...
   */
  public Bp_Diastolic_Term(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Bp_Diastolic_Term(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Bp_Diastolic_Term(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
