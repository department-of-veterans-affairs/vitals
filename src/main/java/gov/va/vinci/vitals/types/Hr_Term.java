...
public class Hr_Term extends Term {
  ...
  public final static int typeIndexID = JCasRegistry.register(Hr_Term.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Hr_Term() {/* intentionally empty block */}
   ...
   */
  public Hr_Term(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Hr_Term(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
