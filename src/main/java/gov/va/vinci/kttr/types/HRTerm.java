 ...
 * @generated */
public class HRTerm extends RefValue {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(HRTerm.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected HRTerm() {/* intentionally empty block */}
   ...
   */
  public HRTerm(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public HRTerm(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
