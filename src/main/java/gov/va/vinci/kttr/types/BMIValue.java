 ...
 * @generated */
public class BMIValue extends RefValue {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BMIValue.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BMIValue() {/* intentionally empty block */}
   ...
   */
  public BMIValue(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public BMIValue(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
