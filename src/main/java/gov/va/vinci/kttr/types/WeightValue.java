 ...
 * @generated */
public class WeightValue extends RefValue {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(WeightValue.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected WeightValue() {/* intentionally empty block */}
   ...
   */
  public WeightValue(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public WeightValue(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
